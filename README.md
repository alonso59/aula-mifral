...
> For contributors: see `.github/COPILOT_BRIEF.md` for the Virtual Classroom spec and phased plan. All features behind `CLASSROOM_MODE=true`. Do not touch core chat; use CourseChat wrapper.
